...
global.dfail = (type, m, conn) => {
  ...
  let msg = {
    ...
    premium: '❌Perintah Ini khusus pengguna _*Premium*_ mau beli premium ketik *#buypremium* !',
    group: 'fitur ini kusus di dalam *group*\nsilahkan join group ku: https://chat.whatsapp.com/L3vqKEnh9BA2rbqcfywZ6W',
    private: '❌Perintah ditolak❌\n\nGunakan Perintah ini di Chat Pribadi bot',
    admin: 'fitur ini kusus *admin group*',
    ...
    unreg: `maaf anda belum daftar di databes bot untuk memakai fitur ini ketik *.button*`
  }[type]
